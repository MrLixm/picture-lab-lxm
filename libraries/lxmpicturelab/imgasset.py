...
class ImageryAssetType(enum.Enum):
    cgi = "cgi"
    """
...
class ImageryAssetMetadata:
    ...
    type: ImageryAssetType = dataclasses.field(
        metadata={
            "serialized-name": "type",
            "caster-in": ImageryAssetType,
            "caster-out": lambda v: v.value,
        },
    )
    ...
    @classmethod
    def from_dict(cls, serialized_dict: dict) -> "ImageryAssetMetadata":
        """
    ...
    @classmethod
    def from_json_file(cls, file_path: Path) -> "ImageryAssetMetadata":
        """
...
class ImageryAsset:
    ...
    @property
    def metadata(self) -> ImageryAssetMetadata:
        return ImageryAssetMetadata.from_json_file(self.json_path)

    @property
    def image_path(self) -> Path | None:
        files = list(self.json_path.parent.glob(f"{self.json_path.stem}.*"))
        files.remove(self.json_path)
        return files[0] if files else None

    @property
    def is_cgi(self) -> bool:
        return self.metadata.type == ImageryAssetType.cgi

    @property
    def is_plate(self) -> bool:
        return self.metadata.type == ImageryAssetType.plate
    ...
    def with_root_path(self, new_root: Path) -> "ImageryAsset":
        """
        ...
        return ImageryAsset(new_json_path)
